...
def main() -> int:
    ...
    try:
        ...
        for index, case in enumerate(plan, 1):
            ...
            prediction = load_json(output_path) if result.returncode == 0 and output_path.is_file() else {}
        ...
        result_doc = {"schema_version": "1.0", "completed_at": utc_now(), "suite": str(args.suite.resolve()), "observations": observations, "metrics": summarize(observations), "failed_observations": failed}
